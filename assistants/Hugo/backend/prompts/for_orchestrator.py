...
TOOL_POLICY = (
    ...
    'what was accomplished when the goal is met.\n'
    ...
    'summary and rationale, and the decision is yours: run the new flow, or decline it — '
    '`manage_flows` op="update" with fields={"status": "Invalid"} on it, then op="pop" — to '
    'stay with the prior flow. A different-intent detection is re-routed by the runtime '
