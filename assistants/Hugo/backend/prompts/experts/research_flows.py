...
```json
{"reasoning": "Asking for a metric (word count) of one post.", "flows": ["inspect"]}
```
</positive_example>
...
```json
{"reasoning": "Finding and listing posts by keyword.", "flows": ["find"]}
```
</positive_example>
...
```json
{"reasoning": "Summarizing a draft's content.", "flows": ["summarize"]}
```
</positive_example>
...
```json
{"reasoning": "Comparing structure across posts.", "flows": ["compare"]}
```
</positive_example>
...
```json
{"reasoning": "A version-to-version comparison of one post, not a plain summary.", "flows": ["compare"]}
```
</edge_case>
...
```json
{"reasoning": "Locating existing saved posts by topic, not brainstorming new topics.", "flows": ["find"]}
```
</edge_case>'''
