...
Evaluations runner (utils/evals/run_evals.py). Importing this sets HUGO_EVAL_MODE and loads .env,
matching the recorder's environment. This is the canonical copy those two share; the parity CLI
scripts (run_parity / smoke_openings / capture_oracle) keep their own _build_agent variants.
"""
import os
import sys
