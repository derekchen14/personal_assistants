...
fixtures under `utils/traces/parity/fixtures/` — the oracle the new orchestrator is compared
...
Run from the Hugo root, one half at a time (E2E two-halves strategy):
  python utils/traces/parity/capture_oracle.py --scenario vision --half 1
  python utils/traces/parity/capture_oracle.py --scenario vision --half 2
"""
...
from utils.traces.parity.comparator import FIXTURE_DIR, capture_db_state
