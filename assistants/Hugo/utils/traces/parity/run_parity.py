...
Run from the Hugo root, one half at a time (E2E two-halves strategy):
  python utils/traces/parity/run_parity.py --scenario vision --half 1
  python utils/traces/parity/run_parity.py --scenario vision --half 2
...
from utils.traces.parity.comparator import (load_fixture, compare_db_end_state,
