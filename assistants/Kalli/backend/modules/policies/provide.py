...
class ProvidePolicy:
    ...
    def _do_scope(self, flow_info, state, tool_dispatcher):
        return self._llm_execute('scope', flow_info, state, tool_dispatcher)

    def _do_persona(self, flow_info, state, tool_dispatcher):
        return self._llm_execute('persona', flow_info, state, tool_dispatcher)

    def _do_intent(self, flow_info, state, tool_dispatcher):
        return self._llm_execute('intent', flow_info, state, tool_dispatcher)

    def _do_entity(self, flow_info, state, tool_dispatcher):
        return self._llm_execute('entity', flow_info, state, tool_dispatcher)
