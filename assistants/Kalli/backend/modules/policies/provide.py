...
class ProvidePolicy:
    ...
    def _do_scope(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('scope', flow_info, nlu_result, tool_dispatcher)

    def _do_persona(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('persona', flow_info, nlu_result, tool_dispatcher)

    def _do_intent(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('intent', flow_info, nlu_result, tool_dispatcher)

    def _do_entity(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('entity', flow_info, nlu_result, tool_dispatcher)
