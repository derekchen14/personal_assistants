...
_BATCH_1 = {'revise', 'approve', 'decline'}
_BATCH_2 = {'remove', 'rework', 'suggest', 'refine', 'validate'}


class PersonalizePolicy:
    ...
    def _do_revise(self, flow_info, state, context, filled_slots, tool_dispatcher):
        return self._llm_execute('revise', flow_info, state, context, filled_slots, tool_dispatcher)

    def _do_approve(self, flow_info, state, context, filled_slots, tool_dispatcher):
        return self._llm_execute('approve', flow_info, state, context, filled_slots, tool_dispatcher)

    def _do_decline(self, flow_info, state, context, filled_slots, tool_dispatcher):
        return self._llm_execute('decline', flow_info, state, context, filled_slots, tool_dispatcher)
