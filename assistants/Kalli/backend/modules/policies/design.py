...
_BATCH_1 = {'propose', 'compose', 'approve', 'decline'}
_BATCH_2 = {'revise_flow', 'suggest_flow', 'refine'}
...
class DesignPolicy:
    ...
    def _do_propose(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('propose', flow_info, nlu_result, tool_dispatcher)

    def _do_compose(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('compose', flow_info, nlu_result, tool_dispatcher)

    def _do_approve(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('approve', flow_info, nlu_result, tool_dispatcher)

    def _do_decline(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('decline', flow_info, nlu_result, tool_dispatcher)
