...
_BATCH_2 = {'rework', 'suggest', 'refine'}
...
class DesignPolicy:
    ...
    def _do_propose(self, flow_info, state, tool_dispatcher):
        return self._llm_execute('propose', flow_info, state, tool_dispatcher)

    def _do_compose(self, flow_info, state, tool_dispatcher):
        return self._llm_execute('compose', flow_info, state, tool_dispatcher)

    def _do_approve(self, flow_info, state, tool_dispatcher):
        return self._llm_execute('approve', flow_info, state, tool_dispatcher)

    def _do_decline(self, flow_info, state, tool_dispatcher):
        return self._llm_execute('decline', flow_info, state, tool_dispatcher)
