...
_BATCH_1 = {'status', 'lookup', 'explain'}
_BATCH_2 = {'review_lessons', 'summarize', 'inspect'}
...
class ExplorePolicy:
    ...
    def _do_status(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('status', flow_info, nlu_result, tool_dispatcher)

    def _do_lookup(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('lookup', flow_info, nlu_result, tool_dispatcher)

    def _do_explain(self, flow_info, nlu_result, tool_dispatcher):
        return self._llm_execute('explain', flow_info, nlu_result, tool_dispatcher)
