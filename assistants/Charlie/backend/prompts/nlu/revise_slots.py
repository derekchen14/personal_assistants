REWORK_PROMPT = {
    ...
    'slots': (
        ...
        "dissatisfaction does NOT fill this slot.\n\n"
        "### image (optional)\n\n"
        "Type: ImageSlot. Grafted from remove: the image being deleted. Fill only when the user asks "
        "to delete an image, diagram, or photo.\n\n"
        "### type (optional)\n\n"
        "Type: CategorySlot. Grafted from remove: post, draft, section, paragraph, note, image — what "
...
AUDIT_PROMPT = {
    ...
    'slots': (
        ...
        "### tone (optional)\n\n"
        "Type: ExactSlot. Grafted from tone: the target register, captured verbatim. May be a "
        ...
        "Type: ChecklistSlot. Grafted from tone: a list of specific tonal shifts the user itemized. "
