...
Run from the Hugo root, one tier per invocation (tiers share pinned post ids — never parallel):
  python utils/tests/parity/smoke_openings.py --tier mid
  python utils/tests/parity/smoke_openings.py --tier high
"""
...
from utils.tests.parity.capture_oracle import SCENARIOS, _clean_leftovers, _run_step, _CRASH_FALLBACK
from utils.tests.parity.comparator import (load_fixture, capture_db_state, compare_grounding,
                                           judge_utterance)
