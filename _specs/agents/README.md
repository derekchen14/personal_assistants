...
**Git workflow (the user 2026-07-04 — no PRs):** (1) develop the plan with the PM, (2) SWEs/DoE/QA write
the code, (3) make a commit, (4) after a few commits, push to master. The user reviews in the loop after
...
6. **Ship** — DoE turns the passing Change set into a **Commit**; the user reviews it live. After a few
